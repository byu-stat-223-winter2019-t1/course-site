...
+ Follow [this link](https://classroom.github.com/a/SNOajqnN) to create your 
...
there four traffic lights, each with a 30% chance of being red when we get to
it. For each light that is red, it adds 2 minutes to the bus ride time to campus
(if all four happened to be red, then that would add 8 minutes to the time and
the total bus ride would take 18 minutes).
...
2018 actual) and it's 95% confidence interval? (10 points)
